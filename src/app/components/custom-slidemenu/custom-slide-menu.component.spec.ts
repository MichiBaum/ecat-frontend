...
import { CustomSlideMenu, CustomSlideMenuSub } from './custom-slide-menu.component';
...
@Component({
  template: `
    <app-customSlideMenu #menu></app-customSlideMenu>
...
describe('SlideMenu', () => {
    ...
    let slidemenu: CustomSlideMenu;
    let slidemenuSub: CustomSlideMenuSub;
